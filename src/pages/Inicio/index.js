...
function Inicio() {
  ...
  async function deleteVideo(id) {
    ...
    await fetch(
      `https://json-server-vercel-git-main-sara-roberta-pires-s-projects.vercel.app/videos/${id}`,
      {
        method: "DELETE",
      }
    );
  ...
  return (
    <>
      <Banner categoria={categorias} aoVisualizarVideo={verVideo} />
      <section>
      ...
      />
      <ModalPlayer video={videoVer} aoFecharModal={fecharModal} />
    </>
  );
}
